...
public interface JobRepo extends CrudRepository<Job, Long> {
    ...
    LinkedHashSet<Job> findByEmployerContainingIgnoreCaseOrderByEmployerAsc(String employer);

    LinkedHashSet<Job> findByTitleContainingIgnoreCaseOrderByTitleAsc(String jobTitle);
